...
if(isset($_POST['simpan'])){
	...
	$update = mysql_query("UPDATE mahasiswa SET mahasiswa_nim='$nim', mahasiswa_nama='$nama', mahasiswa_kelas='$kelas', mahasiswa_jurusan='$jurusan' WHERE mahasiswa_id='$id'") or die(mysql_error());
